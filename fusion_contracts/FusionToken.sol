...
abstract contract ERC20Interface {
    ...
    function balanceOf(address _owner) view virtual public returns (uint256);
...
contract FusionToken is ERC20Interface {
    string public constant symbol = "FUSION";
    string public constant name = "Fusion Fixed Supply Token";
