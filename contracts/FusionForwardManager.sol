...
// ----------------------------------------------------------------------------------------------
// Fusion Forward Manager Inspired from the Ethereum Plasma Archives
...
contract FusionForwardManager {
    ...
    bytes constant FusionMessagePrefixBytes = "\x19Ethereum Signed Message:\n96";
