...
library RLP {
 ...
 uint  DATA_SHORT_START = 0x80;
 uint  DATA_LONG_START = 0xB8;
 uint  LIST_SHORT_START = 0xC0;
 uint  LIST_LONG_START = 0xF8;

 uint  DATA_LONG_OFFSET = 0xB7;
 uint  LIST_LONG_OFFSET = 0xF7;
